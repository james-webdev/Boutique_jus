          ...
          <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 mb-4">
                        ...
                        <div class="card h-100">
                          <a href="index.php?module=produit&action=produit_jus"><img class="card-img-top" src="../app/view/images/02.jpg" alt=""></a>
                  ...
                  <div class="col-lg-6 col-md-6 mb-4">
                      ...
                      <div class="card h-100">
                        <a href="index.php?module=produit&action=produit_laits"><img class="card-img-top" src="../app/view/images/05.jpg" alt=""></a>
                            <div class="card-body">
                              <h4 class="card-title">
                  ...
                  <div class="col-lg-12 col-md-6 mb-4">
                        <div class="card h-100">
                          <a href="index.php?module=produit&action=produit_cures"><img class="card-img-top" src="../app/view/images/Cure_avancée.jpg" alt=""></a>
                              <div class="card-body">
                                <h4 class="card-title">
