...
​       <div class="row">
            <div class="col-lg-3">
                  <h1 class="col-lg-3">Nos Laits</h1>
                  <div class="list-group">
                    ...
                    <br>
                     ...
                     <a href="index.php?module=utilisateur&action=register" class="list-group-item">S'enregistrer</a>
                      ...
                      <div class="row">
                            ...
                            <div class="col-sm-6">
                                        <div class="card-body">
                                          ...
                                          <p class="card-text"><?= $produit ["pro_descr"] ?>
                                          </p>           
                                        </div>
                                                

                                    <form action="index.php?module=cart&action=cart_ajouter_laits" style= "padding: 1.25rem;" method= "post" >
                                      Quantité:
