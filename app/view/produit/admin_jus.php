...
<div class="container">
        <div class="row">
              <div class="col-lg-3">
                    <h1 class="col-lg-3">Admin Jus</h1>
                <div class="list-group">
                    <a href="index.php?module=produit&action=admin_laits" class="list-group-item active">Admin Laits</a>
                    <a href="index.php?module=produit&action=admin_cures" class="list-group-item">Admin Cures</a>
                </div>
              </div>
              ...
              <div class="col-md-9">
                 ...
                 <table style="width:100%">
                          ...
                          <tr>
                            ...
                            <th>
                              <?php $action = "index.php?module=produit&action=supprime_jus&id=".$produit ["pro_id"] ?>
                   ...
                   <form method="post" action="index.php?module=produit&action=ajouter_jus" style="padding: 1.25rem; ">
                          <label>Ajouter un jus</label>
